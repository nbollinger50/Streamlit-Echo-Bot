...
def ai_ask(prompt, data=None, temperature=0.5, max_tokens=250,
    ...
    if api_key is None or api_url is None:
        if "idToken" in globals():
            ...
            api_url = "https://11m.boardflare.com"
        else:
            return "Login on the Funtions tab for limited demo usage, or sign up for a free Mistreal AI account at https://console.mistral.ai/ and add your own api_key."
...
def response_generator():
    response = ai_ask(
        "Pretent you are a very firendly and helpful person. Please provide a response given the provided context.",
